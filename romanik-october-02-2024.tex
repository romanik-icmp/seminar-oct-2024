	...
	\begin{frame}
		...
		\begin{columns}
			\begin{column}{0.5\textwidth}
				...
				\begin{equation*}
					\Xi = \Xi_0(T,V,\mu_0;\eta_0) \Xi_G \Xi_L(T, V, \mu; \eta_0)
				\end{equation*}
				
				\begin{equation*}
					\left(\frac{\partial \ln \Xi}{\partial \beta\mu}\right)_{T,V} = \langle N \rangle = \langle N \rangle_0
				\end{equation*}
			\end{column}
			...
			\begin{column}{0.5\textwidth}
				...
				\begin{equation*}
					\Xi = \Xi_0(T,V,\mu) \Xi_G \Xi_L(T, V, \mu)
				\end{equation*}
				
				\begin{equation*}
					\left(\frac{\partial \ln \Xi}{\partial \beta\mu}\right)_{T,V} = \langle N \rangle = \langle N \rangle_0 + \Delta \langle N \rangle
				\end{equation*}
			\end{column}
